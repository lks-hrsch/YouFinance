-- Add UNIQUE constraint on financial identity across all accounts
-- Prevents cross-provider duplicates by identifying transactions globally
-- (not per-account) using booking_date, amount_minor, debtor_iban, creditor_iban
