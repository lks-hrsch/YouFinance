...
BusinessAccount;00000000;BANKDEFFXXX;Sample Bank;10.01.2024;10.01.2024;Example Payee GmbH;DE00XXXXXXXXXXXXXXX;BANKDEFFXXX;EINZUGSERMAECHTIGUNG;Monthly subscription;-46,55;EUR;;;;;";
...
fn test_unified_parsers(#[case] data: &str, #[case] parser_type: &str) {
    ...
    assert_eq!(tx.booking_text, "EINZUGSERMAECHTIGUNG");
    ...
    assert_eq!(tx.amount_minor, -4655);
    assert_eq!(tx.currency_code, "EUR");
    assert_eq!(tx.booking_date, "2024-01-10");
    assert_eq!(tx.remittance_information.as_deref(), Some("Monthly subscription"));
    assert_eq!(tx.bank_account_id, 99);
}
